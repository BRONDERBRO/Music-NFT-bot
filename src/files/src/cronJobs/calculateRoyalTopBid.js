...
module.exports = async (client, desiredYield, maxPrice) => {
    ...
    const diamondLimitPricePonderation = 0.5 //If the bidPrice is less than limitPrice * limitPricePonderation, and the max bidder is not me, a DM is sent
    const platinumLimitPricePonderation = 0.5 //If the bidPrice is less than limitPrice * limitPricePonderation, and the max bidder is not me, a DM is sent
